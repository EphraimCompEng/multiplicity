...
multiply is a powerful tool to build, test, and analyse multiplier designs.
...
multiply is built to streamline this process:

- Custom partial product reduction via `templates <https://github.com/EphraimCompEng/multiply/blob/master/docs/structures/templates.md>`__
